...
const logo = "https://i.postimg.cc/6320jpGZ/fixed-8.png";
const logoImages = [
  "https://i.postimg.cc/6320jpGZ/fixed-8.png",
  "https://i.postimg.cc/1537tjbK/fixed.png",
];
...
function App() {
  ...
  // Rotar logo/imagen pequeña en nav + footer
  useEffect(() => {
    const id = setInterval(() => {
      setLogoIndex((i) => (i + 1) % logoImages.length);
    }, 3500);
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="text-center px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative mb-8">
              <div className="absolute left-1/2 -top-14 sm:-top-16 md:-top-20 transform -translate-x-1/2 z-0 animate-drop-in pointer-events-none">
                <img
                  src={logo}
                  alt="Logo Life Mate"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-gray-400 text-sm">
              © 2024 Life Mate. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
